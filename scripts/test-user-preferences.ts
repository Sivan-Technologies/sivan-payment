...
async function main() {
  ...
  try {
    ...
    const started: any = await request('POST', '/api/auth/email/start', { email, fullName: 'Prefs User', intent: 'signup', legalAcceptance: { accepted: true, termsVersion: '2026-07-14', privacyVersion: '2026-07-14', riskDisclosureVersion: '2026-07-14' } });
