...
export interface TransferFeeQuote {
  ...
  /** Which rule produced this fee. For the UI, and for answering support. */
 ...
 */
export function quoteTransferFee(amount: number, config: TransferFeeConfig = DEFAULT_TRANSFER_FEE): TransferFeeQuote {
 ...
 */
export const DEFAULT_TRANSFER_MIN_SEND = 5;
