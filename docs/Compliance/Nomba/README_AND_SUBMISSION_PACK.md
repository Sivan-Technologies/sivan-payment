...
Regarding: Outstanding Documents for Sivan Technologies Ltd API Checkout Review  
Date: August 2026  
...
Subject: Re: Outstanding Documents for API Checkout Review — Sivan Technologies Ltd
...
- Documented KYC and KYB Policy: [Attached: Sivan_Technologies_KYC_KYB_Policy.pdf]
  Comprehensive risk-weighted customer due diligence policy covering individual tiers, corporate KYB, and beneficial ownership verification.
- Documented AML/CFT Framework: [Attached: Sivan_Technologies_AML_CFT_Framework.pdf]
...
- Risk and Compliance Department:
  ...
  - Legal Escalations: legal@sivantech.online
