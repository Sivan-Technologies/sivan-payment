...
export function initWebMcp() {
  ...
  console.log('[Sivan WebMCP] Global WebMCP layer initialized.');
  console.log('💡 AI Prompt Request Example:\n   sivan("create 20 USDC agreement with @soliame for Mobile UI Design on solana with 2 milestones")');
}
