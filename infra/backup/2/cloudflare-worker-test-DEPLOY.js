...
// Sivan AI moved to AWS behind ai.sivantech.online.
// Updated here as well as in -FIXED.js: both files carry the same
// health markers, so which one is actually deployed cannot be told
// apart from the outside. Leaving one behind would mean the AI host
// silently reverts the next time that variant is published.
